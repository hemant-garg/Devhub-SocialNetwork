...
const validateSocialinput = require("../../validation/socialMedia");
...
// @desc    add/update User social links
// @access  private
router.post(
	"/social",
	passport.authenticate("jwt", {
	...
	(req, res) => {
		...
		const { githubusername, website, youtube, linkedin, instagram } = req.body;
